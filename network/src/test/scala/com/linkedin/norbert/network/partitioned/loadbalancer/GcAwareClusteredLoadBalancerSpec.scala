...
class GcAwareClusteredLoadBalancerSpec extends SpecificationWithJUnit with WaitFor {
  ...
  "GcAwareClusteredLoadBalancer" should {
     ...
     */
    " ignores the GCing cluster when asked to fan out to <number of clusters> replicas" in {
     ...
     */
    " throws a NoNodesAvailableException if asked for nodes within GCing cluster" in {
